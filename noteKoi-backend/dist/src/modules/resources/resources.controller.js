...
export async function getPublicResources(req, res, next) {
    try {
        const result = await resourcesService.getPublicResources(req.query);
...
export async function getUnitResources(req, res, next) {
    try {
        ...
        const result = await resourcesService.getUnitResources(classroomUnitId, req.query);
        res.json(success(result));
    }
    catch (err) {
        next(err);
...
export async function updateResource(req, res, next) {
    try {
        const id = getParam(req, "id");
        const resource = await resourcesService.updateResource(id, req.body, req.user.classroomUnitId);
