...
/**
 * CRUD Override — Milestone 7 task 4 / wireframe B.26
 * Requires Justification Note (min 20 chars) per Milestone 7 §Validation.
 * POST /platform-admin/resources/:id/override (wirefram-resolution.md §4 B.26).
 */
  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-white">CRUD Override</h1>
